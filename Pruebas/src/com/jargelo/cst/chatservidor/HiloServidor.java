package com.jargelo.cst.chatservidor;
...
public class HiloServidor implements Runnable{
	...
	public HiloServidor(Socket soc,@SuppressWarnings("rawtypes") LinkedList users){
        socket = soc;
        usuarios = users;
    }
        ...
        try {
            ...
            while(true){
               String recibido = in.readUTF();
                System.out.println("Hay conectados "+usuarios.size());

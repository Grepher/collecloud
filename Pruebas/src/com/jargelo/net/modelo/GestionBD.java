...
public class GestionBD {
	...
	public void ejecutar(String sentenciaBD) {
		try {
			...
			JOptionPane.showMessageDialog(null, "No se pudo cargar la informacion de la BD" + e, "Error",
	...
	public ResultSet ejecutarConsulta(String sentenciaBD) {
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "No se pudo realizar la consulta" + e, "Error",
					JOptionPane.ERROR_MESSAGE);
			e.printStackTrace();
		}
		return rs;
